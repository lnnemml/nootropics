...
export function S07ValueProp2() {
  return (
    <LpSection variant="light">
      <div className="grid md:grid-cols-2 gap-10 md:gap-[80px] items-center">
        <div>
          <h2 className="font-sans text-[28px] md:text-[34px] font-bold text-[#2b3235] leading-tight tracking-[-0.015em] [text-wrap:pretty] mb-5">
            Wake Up Actually Wanting to Work Instead of Forcing Yourself Through Another Day
          </h2>
          <p className="font-sans text-[17px] text-[#2b3235]/80 leading-[1.7] mb-4">
          ...
          <p className="font-sans text-[17px] text-[#2b3235]/80 leading-[1.7] mb-8">
        ...
        <div className="relative">
          ...
          <div className="absolute top-6 left-6 -right-6 -bottom-6 border border-[#1e9c78]/35 rounded-[2px] pointer-events-none" />
          {/* Image container */}
          <div className="relative h-[400px] md:h-[540px] rounded-[2px] overflow-hidden shadow-[0_48px_96px_-48px_rgba(43,50,53,0.5)]">
            <Image
